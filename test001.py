...
coherence = ['but', 'therefore', 'so', 'as a result', 'that is why', 'consequently', 'accordingly', 'as a result',
...
r = requests.get('http://www.scifiscripts.com/scripts/batmanandrobin.txt')
